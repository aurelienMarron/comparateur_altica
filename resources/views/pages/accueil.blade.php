...
@section('content')
    <div class="container">
        <div class="text-center">
            <h5 class="text-center"><strong>Bienvenue !</strong><br> Voici le tout premier <strong> comparateur</strong><br> de niveaux de services de <strong>traduction</strong></h5>
        </div>
        ...
        <div class="text-center" id="lienComparateur">
            <a href="{{route('comparateur')}}">
                <button type="button" class="btn btn-primary" id="lien">Je teste le comparateur
                </button>
            </a>
        </div>
