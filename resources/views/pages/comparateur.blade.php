                    ...
                    <div class="panel-body container">
                        <form class="form" action="{{ route('validation') }}" method="POST">
                            ...
                            <div class="form-group">
                                <br>
                                <h6>Merci de saisir le texte à traduire ou directement le nombre de mot à traduire</h6>
                                <label for="rawtext">Texte à traduire (celui-ci ne sera pas enregistré)</label>
                                <textarea class="form-control @error('rawtext') is-invalid @enderror" name="rawtext"
                                          id="rawtext" rows="10"
                                          oninput="calculNbMots()"
                                          placeholder="Je saisis mon texte à traduire"></textarea>
                                ...
                                <div class="form-group row">
                                    <label for="nbmots" class="col-sm-5 col-form-label">Je saisis le nombre de mots si
                                        je n'ai pas saisis de texte à traduire :</label>
                                    <div class="col-sm-2">
                            ...
                            <div class="form-group m-2 ">
                                <label for="customRange2" class="form-label">Je choisis la qualité de traduction
                                    souhaitée en déplaçant le curseur : </label>
                                <div class="container">
    ...
    <script type="text/javascript">
        ...
        function calculNbMots() {
            var mots=document.getElementById('rawtext').value;
                ...
                document.getElementById('nbmots').value = nombre;
        }
